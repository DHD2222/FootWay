...
public class ViewKhachHang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGap(28, 28, 28)
                .addComponent(btnpreve, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (validateForm()) {
            ...
            if (qlkh.checktrungsodienthoai(phoneNumber)) {
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        if (TenKH.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập tên khách hàng để tìm kiếm.");
            return;
        }
        QuanLyKhachHangService khachHangService = new QuanLyKhachHangService();
        List<KhachHang> result = khachHangService.SearchKhachHang(TenKH);
        if (result.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Không tìm thấy khách hàng với mã hoặc tên: " + TenKH);
        } else {
    ...
    private void btnendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnendActionPerformed
        // TODO add your handling code here:
        int totalPages = qlkh.getTongSoTrang();
    ...
    private void LocTrangThaiNhanvien(int trangThai) {
        List<KhachHang> khachHangList = qlkh.LocTrangThai(trangThai);
        dtm.setRowCount(0);
    ...
    private void rdohoatdongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdohoatdongActionPerformed
        // TODO add your handling code here:
        LocTrangThaiNhanvien(1);
    }//GEN-LAST:event_rdohoatdongActionPerformed

    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        // TODO add your handling code here:
        LocTrangThaiNhanvien(0);
    ...
    private boolean validateForm() {
        ...
        if (!txtTenKhachHang.getText().matches("^[a-zA-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯẠ-ỹ\\s]+$")) {
