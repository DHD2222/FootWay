...
public class ViewNhaCungCap extends javax.swing.JFrame {
    ...
    private void loadTrangThai(int trangThai) {
        ArrayList<NhaCungCap> nhaCungCapList = qlncc.LocTrangThai(trangThai);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (validateForm()) {
            ...
            if (qlncc.checkTrungMa(maMauSac)) {
            ...
            if (chon == JOptionPane.YES_OPTION) {
                ...
                qlncc.addNhaCungCap(readFormNgayTao());
                fillTable(qlncc.getAllNhaCungCap());
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        if (index >= 0) {
            ...
            if (chon == JOptionPane.YES_OPTION) {
                try {
                    NhaCungCap nv = readFormNgaySua();
                    if (nv == null) {
                        return;
                    }
                    Integer id = Integer.valueOf(lblId.getText());
                    qlncc.updateNhaCungCap(readFormNgaySua(), id);
    ...
    private NhaCungCap readFormNgayTao() {
        int a;
    ...
    private NhaCungCap readFormNgaySua() {
        int a;
        LocalDateTime ldt = LocalDateTime.now();
